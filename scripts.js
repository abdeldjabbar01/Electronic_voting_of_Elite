...
/**
 * project page refresh to update data 
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initResultsForm();
    initAddOptionButton();
    initCountdownAutoRefresh();
});

/**
 * Auto-refresh page when any vote countdown reaches zero
 */
function initCountdownAutoRefresh() {
    ...
    function checkCountdowns() {
        ...
        if (shouldReload) {
            ...
            setTimeout(checkCountdowns, 1000);
        }
    }
    setTimeout(checkCountdowns, 1000);
}
